...
This keymap is better used with the Monsgeek firmware from: <https://github.com/MonsGeek/qmk_firmware>
...
# To build, do:
qmk compile -kb monsgeek/m1_v5/m1_v5_us -km carlosedp_)upstream
```
