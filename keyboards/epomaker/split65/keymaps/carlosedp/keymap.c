...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        RM_NEXT, KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   DEVS_USB,           KC_Y,     KC_U,     KC_I,     KC_O,      KC_P,     RM_HUED, RM_HUEU,  KC_BSLS,  KC_INS,
        KC_TRNS, KC_NO,    TO(_MBL), KC_NO,    KC_NO,    KC_NO,              KC_H,     KC_J,     KC_K,     KC_L,      RM_SATD,  RM_SATU, KC_ENT,             KC_HOME,
        KC_LSFT, KC_NO,    RM_TOGG,  KC_NO,    KC_M,     KC_ENT,             NK_TOGG,  KC_M,     KC_COMM,  KC_DOT,    KC_SLSH,           KC_RSFT,  RM_VALU,  KC_END,
        KC_NO,   GU_TOGG,  KC_LALT,  KC_BATQ,                                KC_SPC,   KC_RALT,  KC_NO,    KC_RCTL,                     RM_SPDD,  RM_VALD,  RM_SPDU),
