...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_all(
        ...
        KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MT(MOD_RSFT, KC_GRV), KC_UP, KC_DEL,
    ...
    LAYOUT_all(
        ...
        KC_NO, BL_DOWN, BL_UP, BL_ON, BL_OFF, BL_STEP, BL_BRTG, KC_NO, KC_NO, KC_NO, KC_MPLY, KC_BRID, KC_BRIU, KC_NO,
        MO(1), RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, RGB_MODE_PLAIN, KC_NO, KC_NO, KC_NO, KC_ENT,
        KC_LSFT, KC_NO, DM_REC1, DM_PLY1, DM_REC2, DM_PLY2, DM_RSTP, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_RSFT, KC_PGUP, KC_INS,
